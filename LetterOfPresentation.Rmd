...
As a member of the Poisot lab, I would like to explore the relationship between species interaction networks, spatial scale, and species diversity to better understand how and where species can coexist. Being able to accurately infer species interactions based on functional traits and spatio-temporal relationships would be huge step forward for ecologist's ability to generate large scale interaction networks. To accomplish this using artificial intelligence, huge amounts of formalized interaction data would be needed. In order to generate these large and clean datasets from existing data, it may be necessary to produce a naturual language processing model that can reliably extract high quality interaction data from GBIF and literature, as well as increase access to schemas and ontologies that inherintly capture formalized interactions. 
